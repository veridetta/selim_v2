      ...
      var dt_ang = dt_anggota.DataTable({
        ...
        columnDefs: [
          ...
          }@if(auth()->user()->role=='admin'),
          {
            ...
            orderable: false,
            render: function (data, type, full, meta) {
              return '<div class="text-center"> <a class="a_delete btn btn-danger" pdf="'+full.id_users+'" href="//{{request()->getHttpHost()}}/admin/lembur_delete/'+full.id+'">Hapus</a></div>';
            }
          }@endif
