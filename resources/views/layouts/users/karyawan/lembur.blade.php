...
<section id="dashboard-analytics">
  @include('panels.flash')
      <div class="col-lg-12 col-sm-12 col-12">
        ...
        aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#backdrop"><span>Tambah</span></button>
        @endif
        <div class="card">
          ...
          <div class="card-header bg-danger flex-column align-items-start">
            <div class="row col-12">
                ...
                <div class="col-lg-11 col-10 my-auto">
                    <p class="h4 card-text text-white">Riwayat Lembur Karyawan</p>
                </div>
            </div>
          </div>
          <div class="card-body" >
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="add-new-user pt-0" method="POST" action="{{route('lembur-add-karyawan')}}">
                @csrf
                ...
                <div class="mb-1">
                  <label class="form-label" for="basic-icon-default-lama">Lama (Jam)</label>
                  <input
                    type="number"
...
$(function () {
    ...
    if (dt_anggota.length) {
      var dt_ang = dt_anggota.DataTable({
        ajax: "{{route('lembur-data-karyawan')}}",
        columns: [
          { data: '' },
          { data: 'id_karyawan' },
          { data: 'nama' },
